...
public class SectionFile {
    ...
    public static SectionFile fromInputStream(InputStream is, String sectionName, boolean allowDuplicates) {
     ...
     * @return
     */
    public static SectionFile fromReader(Reader rawReader, String sectionName, boolean allowDuplicates) {
                ...
                if (line.startsWith("[") && line.endsWith("]")) {
                    ...
                    if (line.equals("}")) {
                        ...
                        for (int i = 0; i < values.length; i++) {
                            String fieldName = String.format("%s%d.%s",
                                    currentSection.getLastEntryName(), tableLineNo,
                                    i < columns.size() ? columns.get(i) : columns.get(columns.size() - 1) + "," + (i - columns.size() + 1));
