...
public class CivServer extends org.java_websocket.server.WebSocketServer {
  ...
  public CivServer(InetSocketAddress address, GameLogger logger) {
    super(address);
      this.logger = logger;
  ...
  public void onMessage(WebSocket conn, String packet) {
    logger.info("Message received: " + packet);
  ...
  public void sendRulesetUnitAll(
      long id,
      String name,
      String graphic_str,
      int move_rate,
  ...
  public void sendCityShortInfoAll(
      long id,
      int owner,
      int tile,
      int size,
  ...
  public void sendNationInfoAll(
      long id, String name, String adjective, String graphic_str, String legend) {
    JSONObject msg = new JSONObject();
  ...
  public void sendTechAll(
      long id,
      int root_req,
      String name,
      JSONArray research_reqs,
      String graphic_str,
      String helptext) {
    JSONObject msg = new JSONObject();
