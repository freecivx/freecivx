...
var ACTION_SPY_BRIBE_STACK = 24;
var ACTION_CAPTURE_UNITS = 25;
var ACTION_SPY_SABOTAGE_UNIT = 26;
var ACTION_SPY_SABOTAGE_UNIT_ESC = 27;
var ACTION_FOUND_CITY = 28;
var ACTION_JOIN_CITY = 29;
var ACTION_STEAL_MAPS = 30;
var ACTION_STEAL_MAPS_ESC = 31;
var ACTION_SPY_NUKE = 32;
var ACTION_SPY_NUKE_ESC = 33;
var ACTION_NUKE = 34;
var ACTION_NUKE_CITY = 35;
var ACTION_NUKE_UNITS = 36;
var ACTION_DESTROY_CITY = 37;
var ACTION_EXPEL_UNIT = 38;
var ACTION_DISBAND_UNIT_RECOVER = 39;
var ACTION_DISBAND_UNIT = 40;
var ACTION_HOME_CITY = 41;
var ACTION_HOMELESS = 42;
var ACTION_UPGRADE_UNIT = 43;
var ACTION_CONVERT = 44;
var ACTION_AIRLIFT = 45;
var ACTION_ATTACK = 46;
var ACTION_ATTACK2 = 47;
var ACTION_SUICIDE_ATTACK = 48;
var ACTION_SUICIDE_ATTACK2 = 49;
var ACTION_STRIKE_BUILDING = 50;
var ACTION_STRIKE_PRODUCTION = 51;
var ACTION_CONQUER_CITY_SHRINK = 52;
var ACTION_CONQUER_CITY_SHRINK2 = 53;
var ACTION_CONQUER_CITY_SHRINK3 = 54;
var ACTION_CONQUER_CITY_SHRINK4 = 55;
var ACTION_BOMBARD = 56;
var ACTION_BOMBARD2 = 57;
var ACTION_BOMBARD3 = 58;
var ACTION_BOMBARD4 = 59;
var ACTION_BOMBARD_LETHAL = 60;
var ACTION_BOMBARD_LETHAL2 = 61;
var ACTION_ROAD = 62;
var ACTION_ROAD2 = 63;
var ACTION_IRRIGATE = 64;
var ACTION_IRRIGATE2 = 65;
var ACTION_MINE = 66;
var ACTION_MINE2 = 67;
var ACTION_BASE = 68;
var ACTION_BASE2 = 69;
var ACTION_PILLAGE = 70;
var ACTION_PILLAGE2 = 71;
var ACTION_TRANSPORT_BOARD = 72;
var ACTION_TRANSPORT_BOARD2 = 73;
var ACTION_TRANSPORT_BOARD3 = 74;
var ACTION_TRANSPORT_DEBOARD = 75;
var ACTION_TRANSPORT_EMBARK = 76;
var ACTION_TRANSPORT_EMBARK2 = 77;
var ACTION_TRANSPORT_EMBARK3 = 78;
var ACTION_TRANSPORT_EMBARK4 = 79;
var ACTION_TRANSPORT_DISEMBARK1 = 80;
var ACTION_TRANSPORT_DISEMBARK2 = 81;
var ACTION_TRANSPORT_DISEMBARK3 = 82;
var ACTION_TRANSPORT_DISEMBARK4 = 83;
var ACTION_TRANSPORT_LOAD = 84;
var ACTION_TRANSPORT_LOAD2 = 85;
var ACTION_TRANSPORT_LOAD3 = 86;
var ACTION_TRANSPORT_UNLOAD = 87;
var ACTION_SPY_SPREAD_PLAGUE = 88;
var ACTION_SPY_ATTACK = 89;
var ACTION_CONQUER_EXTRAS = 90;
var ACTION_CONQUER_EXTRAS2 = 91;
var ACTION_CONQUER_EXTRAS3 = 92;
var ACTION_CONQUER_EXTRAS4 = 93;
var ACTION_HUT_ENTER = 94;
var ACTION_HUT_ENTER2 = 95;
var ACTION_HUT_ENTER3 = 96;
var ACTION_HUT_ENTER4 = 97;
var ACTION_HUT_FRIGHTEN = 98;
var ACTION_HUT_FRIGHTEN2 = 99;
var ACTION_HUT_FRIGHTEN3 = 100;
var ACTION_HUT_FRIGHTEN4 = 101;
var ACTION_HEAL_UNIT = 102;
var ACTION_HEAL_UNIT2 = 103;
var ACTION_PARADROP = 104;
var ACTION_PARADROP_CONQUER = 105;
var ACTION_PARADROP_FRIGHTEN = 106;
var ACTION_PARADROP_FRIGHTEN_CONQUER = 107;
var ACTION_PARADROP_ENTER = 108;
var ACTION_PARADROP_ENTER_CONQUER = 109;
var ACTION_WIPE_UNITS = 110;
var ACTION_SPY_ESCAPE = 111;
var ACTION_UNIT_MOVE = 112;
var ACTION_UNIT_MOVE2 = 113;
var ACTION_UNIT_MOVE3 = 114;
var ACTION_TELEPORT = 115;
var ACTION_TELEPORT2 = 116;
var ACTION_TELEPORT3 = 117;
var ACTION_TELEPORT_CONQUER = 118;
var ACTION_TELEPORT_FRIGHTEN = 119;
var ACTION_TELEPORT_FRIGHTEN_CONQUER = 120;
var ACTION_TELEPORT_ENTER = 121;
var ACTION_TELEPORT_ENTER_CONQUER = 122;
var ACTION_CLEAN = 123;
var ACTION_CLEAN2 = 124;
var ACTION_COLLECT_RANSOM = 125;
var ACTION_FORTIFY = 126;
var ACTION_FORTIFY2 = 127;
var ACTION_CULTIVATE = 128;
var ACTION_CULTIVATE2 = 129;
var ACTION_PLANT = 130;
var ACTION_PLANT2 = 131;
var ACTION_TRANSFORM_TERRAIN = 132;
var ACTION_TRANSFORM_TERRAIN2 = 133;
var ACTION_GAIN_VETERANCY = 134;
var ACTION_ESCAPE = 135;
var ACTION_CIVIL_WAR = 136;
var ACTION_FINISH_UNIT = 137;
var ACTION_FINISH_BUILDING = 138;
var ACTION_USER_ACTION1 = 139;
var ACTION_USER_ACTION2 = 140;
var ACTION_USER_ACTION3 = 141;
var ACTION_USER_ACTION4 = 142;
var ACTION_COUNT = 143;

// Backward compatibility aliases
var ACTION_RECYCLE_UNIT = ACTION_DISBAND_UNIT_RECOVER;
var ACTION_CONQUER_CITY = ACTION_CONQUER_CITY_SHRINK;
var ACTION_CONQUER_CITY2 = ACTION_CONQUER_CITY_SHRINK2;
var ACTION_CONQUER_CITY3 = ACTION_CONQUER_CITY_SHRINK3;
var ACTION_CONQUER_CITY4 = ACTION_CONQUER_CITY_SHRINK4;
