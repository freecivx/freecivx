...
function update_game_info_pregame()
{
  ...
  if (scenario_info != null && scenario_info['is_scenario']) {
    ...
    game_info_html += "<p>";
    game_info_html += html_safe(scenario_info['description']).replace(/\n/g, "<br>");
    game_info_html += "</p>";
    ...
    if (scenario_info['authors']) {
      ...
      game_info_html += html_safe(scenario_info['authors']).replace(/\n/g, "<br>");
      game_info_html += "</p>";
    }
    ...
    if (scenario_info['prevent_new_cities']) {
      ...
      game_info_html += "<p>";
      game_info_html += html_safe(scenario_info['name'])
