...
<% if (!webgpu) { %>
  <script type="importmap">
        {
                "imports": {
                        "three": "/javascript/webgl/libs/r173c/three.module.min.js?ts=${initParam.buildTimeStamp}"
                }
        }
  </script>
<% } else { %>
  <script type="importmap">
        {
                "imports": {
                        "three": "/javascript/webgpu/libs/r173/three.webgpu.min.js?ts=${initParam.buildTimeStamp}"
                }
        }
  </script>
<% } %>
