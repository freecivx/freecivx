<div>
  ...
  <div id="nations_button_div">
    ...
    <button id="withdraw_vision_button" type="button" class="button" title="">Withdraw Vision</button>
    ...
    <button id="intelligence_report_button" type="button" class="button" title="">Intelligence report</button>
    <button id="send_message_button" type="button" class="button" title="">Send message</button>
  </div> 
