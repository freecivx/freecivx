...
echo ""
echo "3. For websockify support (for WebSocket tunneling):"
echo "   - Build websockify-c (C implementation, no Python needed):"
echo "     ./compile_websockify_c_v86.sh"
echo "     cp websockify-v86/bin/websockify board/v86/rootfs_overlay/usr/local/bin/"
echo "   - websockify-c is preferred over Python version as it's faster"
echo "     and has no dependencies (statically linked)"
echo ""
